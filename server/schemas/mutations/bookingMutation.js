...
const stripe = new Stripe(
  "sk_test_51Hr13fE7BvSkBO4pKZaivsbiLMdykp67V4jDLs2sb8Gjuu9crHPBs9yHKv59acXvEa89INAoNgL2PXHPOcdGgnDc005AlcrJd1"
);
...
const addBooking = {
  ...
  async resolve(parent, args) {
    ...
    console.log("args\n", args);
    let query = await Booking.findOne({
      from: args.from,
      to: args.to,
      room: args.room,
    });
    if (query) {
      ...
      let cntDays =
        Math.abs(new Date(args.to).getDate() - new Date(args.from).getDate()) +
        1;
